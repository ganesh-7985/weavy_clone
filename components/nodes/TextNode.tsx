...
function TextNodeComponent({ id, data, selected }: NodeProps) {
  ...
  return (
    <div
      className="bg-[#212126] border border-[#2a2a35] rounded-xl shadow-xl w-[465px] h-[220px] transition-all duration-150"
    ...
    >
      ...
      <div className="px-4 pb-4">
        <textarea
          ...
          className="w-full h-[120px] px-3 py-2.5 bg-[#353539] border border-[#3a3a45] rounded-lg text-sm text-white placeholder-[#555555] resize-none focus:outline-none transition-colors"
        />
      </div>
