...
export function ProjectsPage({ onOpenWorkflow, onCreateNew, onLoadTemplate }: ProjectsPageProps) {
  ...
  return (
    <div className="h-full w-full bg-[#0d0d12] flex">
      {/* Left Sidebar */}
      <div className="w-48 h-full bg-[#0d0d12] flex flex-col py-4">
        {/* User Dropdown */}
        ...
        <div className="flex-1 px-2">
          ...
          <button className="w-full flex items-center gap-3 px-3 py-2 text-[#666666] text-sm rounded-lg hover:bg-[#1a1a1f] transition-colors">
        ...
        <div className="px-2 mt-auto">
          <button 
            ...
            className="w-full flex items-center gap-3 px-3 py-2 text-[#666666] text-sm rounded-lg hover:bg-[#1a1a1f] hover:text-white transition-colors"
          >
          ...
          <div className="bg-[#18181b] rounded-xl p-4 mb-8">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-[#333] scrollbar-track-transparent">
              {currentItems.map((item) => (
                ...
                >
                  <div className="aspect-4/3 bg-[#252528] rounded-lg mb-2 flex items-center justify-center overflow-hidden group-hover:ring-1 group-hover:ring-[#f6ffa8] transition-all">
                    <Sparkles className="w-8 h-8 text-[#444] group-hover:text-[#f6ffa8]" />
                  </div>
